# ARXivarNEXT.Client.Model.AdditionalFieldClasseDTO
## Properties
...
**Value** | **List&lt;int?&gt;** | Value | [optional] 
**ComposedValues** | [**List&lt;RowSearchResult&gt;**](RowSearchResult.md) | List of search items | [optional] 
**DocumentType** | [**DocumentTypeBaseDTO**](DocumentTypeBaseDTO.md) | Document Type for profiling | [optional] 
**InsertMaskId** | **string** | Identifier of the profiling mask | [optional] 
**ShowExpanded** | **bool?** | Show all expanded items | [optional] 
**SingleElement** | **bool?** | Only one item | [optional] 
**Columns** | [**List&lt;ColumnInfo&gt;**](ColumnInfo.md) | Columns to show | [optional] 
