# ARXivarNEXT.Client.Model.FieldBaseForSearchDateTimeDto
## Properties
...
**Valore1** | **DateTime?** | The value of this field | [optional] 
**Valore2** | **DateTime?** | The second value for this field (used only for some operator) | [optional] 
