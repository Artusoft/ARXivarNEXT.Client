# ARXivarNEXT.Client.Model.FieldBaseForSearchAooDto
## Properties
...
**Valore1** | [**AooSearchFilterDto**](AooSearchFilterDto.md) | The value of this field | [optional] 
**Valore2** | [**AooSearchFilterDto**](AooSearchFilterDto.md) | The second value for this field (used only for some operator) | [optional] 
