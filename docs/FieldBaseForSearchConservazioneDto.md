# ARXivarNEXT.Client.Model.FieldBaseForSearchConservazioneDto
## Properties
...
**Valore1** | [**ReplacementStorageSearchFilterDto**](ReplacementStorageSearchFilterDto.md) | The value of this field | [optional] 
**Valore2** | [**ReplacementStorageSearchFilterDto**](ReplacementStorageSearchFilterDto.md) | The second value for this field (used only for some operator) | [optional] 
