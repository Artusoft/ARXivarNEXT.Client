# ARXivarNEXT.Client.Api.PreviewsApi
...
namespace Example
{
    public class PreviewsGetPageNumberByDocnumberExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling PreviewsApi.PreviewsGetPageNumberByDocnumber: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class PreviewsGetPreviewByPageNumberAndDocnumberExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling PreviewsApi.PreviewsGetPreviewByPageNumberAndDocnumber: " + e.Message );
            }
        }
    }
}
