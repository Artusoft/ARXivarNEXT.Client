...
namespace ARXivarNEXT.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AdditionalFieldDoubleDTO : FieldBaseDTO,  IEquatable<AdditionalFieldDoubleDTO>
    {
        /// <summary>
