...
namespace ARXivarNEXT.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MailMassiveForProfileRequestDTO :  IEquatable<MailMassiveForProfileRequestDTO>
    {
        /// <summary>
        ...
        public MailMassiveForProfileRequestDTO(List<int?> items = default(List<int?>), bool? forView = default(bool?), bool? createZip = default(bool?), bool? addAttachments = default(bool?), bool? convertToPdf = default(bool?))
        {
            this.Items = items;
