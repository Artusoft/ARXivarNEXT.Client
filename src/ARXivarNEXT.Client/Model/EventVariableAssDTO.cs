...
namespace ARXivarNEXT.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EventVariableAssDTO :  IEquatable<EventVariableAssDTO>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EventVariableAssDTO" /> class.
        /// </summary>
        ...
        /// <param name="filterField">filterField.</param>
        public EventVariableAssDTO(string diagramVariableId = default(string), string diagramVariableName = default(string), DiagramVariableTypeEnum? diagramVariableType = default(DiagramVariableTypeEnum?), EventFilterableDTO filterField = default(EventFilterableDTO))
        {
        ...
        /// </summary>
        [DataMember(Name="filterField", EmitDefaultValue=false)]
        public EventFilterableDTO FilterField { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EventVariableAssDTO {\n");
        ...
        {
            return this.Equals(input as EventVariableAssDTO);
        }

        /// <summary>
        /// Returns true if EventVariableAssDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of EventVariableAssDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EventVariableAssDTO input)
        {
            if (input == null)
                return false;
