...
namespace ARXivarNEXT.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MailAccountReceiveSettingsPop3DTO : MailAccountReceiveSettingsDTO,  IEquatable<MailAccountReceiveSettingsPop3DTO>
    {
        /// <summary>
