...
namespace ARXivarNEXT.Client.Api
{
    ...
    public interface ICacheApi : IApiAccessor
    {
        ...
        ApiResponse<List<string>> CacheInsertWithHttpInfo (System.IO.Stream _file);
        ...
        System.Threading.Tasks.Task<List<string>> CacheInsertAsync (System.IO.Stream _file);
        ...
        System.Threading.Tasks.Task<ApiResponse<List<string>>> CacheInsertAsyncWithHttpInfo (System.IO.Stream _file);
    ...
    public partial class CacheApi : ICacheApi
    {
        ...
        /// <returns></returns>
        public CacheApi(ARXivarNEXT.Client.Client.Configuration configuration = null)
        {
        ...
        /// <param name="_file">The file</param>
        /// <returns>List&lt;string&gt;</returns>
        public List<string> CacheInsert (System.IO.Stream _file)
        {
             ApiResponse<List<string>> localVarResponse = CacheInsertWithHttpInfo(_file);
        ...
        /// <param name="_file">The file</param>
        /// <returns>ApiResponse of List&lt;string&gt;</returns>
        public ApiResponse< List<string> > CacheInsertWithHttpInfo (System.IO.Stream _file)
        {
        ...
        /// <param name="_file">The file</param>
        /// <returns>Task of List&lt;string&gt;</returns>
        public async System.Threading.Tasks.Task<List<string>> CacheInsertAsync (System.IO.Stream _file)
        {
             ApiResponse<List<string>> localVarResponse = await CacheInsertAsyncWithHttpInfo(_file);
             return localVarResponse.Data;
        ...
        /// <param name="_file">The file</param>
        /// <returns>Task of ApiResponse (List&lt;string&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<string>>> CacheInsertAsyncWithHttpInfo (System.IO.Stream _file)
        {
            // verify the required parameter '_file' is set
            if (_file == null)
                throw new ApiException(400, "Missing required parameter '_file' when calling CacheApi->CacheInsert");
